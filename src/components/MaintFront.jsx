                    ...
                    <div className='flex max-w-md h-45 marco '>
                        <div className="px-6  py-3  ">
                            <div className='flex justify-between items-center'>
                                <div className="font-[CD-SemiBold] text-3xl text-white mb-2">Profesional</div>
                                {/*Icono*/}
                            ...
                            <p className='text-white font-archivo pt-3'>
                                Desarrollador frontend, con pasión por construir interfaces web intuitivas y accesibles.
                                Desde la idea hasta la pantalla.
                            </p>
                        </div>
                    </div>

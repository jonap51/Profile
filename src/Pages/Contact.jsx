...
const Contact = () => {
 ...
 text-white text-6xl'
        ...
        <img
          ...
          alt='image svg'
        />
        <div className='rayo absolute bg-violeta-style/50 left-215 bottom-0' />
        <div className='rombos-imagen absolute bg-azul-oscuro-style  -right-5 -top-2' />
      </section>
    </Element>
  )
}
